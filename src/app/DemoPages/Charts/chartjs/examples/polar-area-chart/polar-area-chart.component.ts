...
@Component({
  ...
  imports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, NgbModule, FontAwesomeModule, BaseChartDirective],  styleUrls: ['./polar-area-chart.component.scss']
})
