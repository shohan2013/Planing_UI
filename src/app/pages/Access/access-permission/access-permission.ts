...
export class AccessPermission {
   ...
   constructor(private permissionservice: AccessService,private commonservice: CommonService, private modalService: NgbModal){
   ...
   GetPermissionData(name:string)
    {
        ...
        this.permissionservice.Permission(name).pipe(takeUntil(this.destroy$)).subscribe({ next : (data) => {
          console.log(data);
